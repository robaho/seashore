...
/*!
 @function    NSStringFromIntPoint
 @discussion    Given an IntPoint convert to string representation
 @param        point
 The IntPoint to convert.
 @result        Returns an NSString representation of the IntPoint.
 */
...
CG_INLINE bool IntRectIsEqual(IntRect r1,IntRect r2) {
