...
//! Project version number for SeaLibrary.
FOUNDATION_EXPORT double SeaLibraryVersionNumber;

//! Project version string for SeaLibrary.
FOUNDATION_EXPORT const unsigned char SeaLibraryVersionString[];
