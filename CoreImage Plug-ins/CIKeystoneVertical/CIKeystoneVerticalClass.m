...
#import "CIKeystoneVerticalClass.h"

@implementation CIKeystoneVerticalClass

- (id)initWithManager:(PluginData *)data
{
    return [super initWithManager:data filter:@"CIKeystoneCorrectionVertical" points:4 bg:TRUE properties:kCI_FocalLength,nil];
}
